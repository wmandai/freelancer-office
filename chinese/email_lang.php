...
$lang['email_sent'] = "你的信息已经通过以下协议成功发送Your message has been successfully sent using the following protocol: %s";
$lang['email_no_socket'] = "不能打开Sendmail套接字。请检查设定。";
$lang['email_no_hostname'] = "你没有指定一个SMTP主机名。You did not specify a SMTP hostname.";
